<!DOCTYPE html>
<!-- Last Published: Mon Feb 10 2025 09:23:11 GMT+0000 (Coordinated Universal Time) -->
<html data-wf-domain="prodwf.media.net" data-wf-page="6707b682c0cfebcc246986ce" data-wf-site="66ed1f19164e8996fdcbd2db">
    <head>
        ...
        <script type="text/javascript">
            WebFont.load({
                google: {
                    families: ["Gabarito:regular,500,600,700", "DM Sans:regular,500,600,700,800"]
                }
            });
        </script>
        <script type="text/javascript">
        ...
        <link href="https://cdn.prod.website-files.com/66ed1f19164e8996fdcbd2db/67581bcb97ff191209aa7350_webf-favicon.png" rel="shortcut icon" type="image/x-icon"/>
        <link href="https://cdn.prod.website-files.com/66ed1f19164e8996fdcbd2db/6762b073133767720baeb3b7_favicon-256X256.png" rel="apple-touch-icon"/>
        <!-- gtag function -->
        <script>
        ...
        <!-- end gtag function -->
        <?php
        //do_action( 'cookie_pro_script' ); ?>
        <!-- Google Tag Manager -->
        <script>
            (function() {
                window.mnetGetCookie = function(e) {
                    try {
                        if (!document.cookie)
                            return "";
                        for (var o = document.cookie.indexOf(e + "="); o > 0 && ";" != document.cookie.substring(o - 1, o) && " " != document.cookie.substring(o - 1, o); )
                            o = document.cookie.indexOf(e + "=", o + 1);
                        var n = o + e.length + 1;
                        if (!o && e !== document.cookie.substring(0, e.length))
                            return null;
                        if (-1 === o)
                            return null;
                        var t = document.cookie.indexOf(";", n);
                        return -1 === t && (t = document.cookie.length),
                        unescape(document.cookie.substring(n, t))
                    } catch (e) {
                        return null
                    }
                }
