...
<footer id="footer" class="section-footer">
                        ...
                        <div class="padding-global">
                            <div class="container-large">
                                <div class="section-footer_top">
                                    <div class="section-footer_links-row">
                                        <div class="section-footer_links-col reset-margin">
                                            <div class="text-weight-bold">
                                                <div class="text-size-xxsmall">Company</div>
                                            </div>
                                            <div class="spacer-xsmall"></div>
                                            <div class="section-footer_links">
                                                <a href="/aboutus" class="section-footer_link w-inline-block">
                                                    <div>About Us</div>
                                                </a>
                                                <a href="/resources/" class="section-footer_link w-inline-block">
                                                    <div>Press Room</div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="section-footer_links-col">
                                            <div class="text-weight-bold">
                                                <div class="text-size-xxsmall">Solutions</div>
                                            </div>
                                            <div class="spacer-xsmall"></div>
                                            <div class="section-footer_links">
                                                <a href="/publishers" class="section-footer_link w-inline-block">
                                                    <div>For Publishers</div>
                                                </a>
                                                <a href="/advertiser" class="section-footer_link w-inline-block">
                                                    <div>For Advertisers</div>
                                                </a>
                                                <a href="/outcomes" class="section-footer_link hide w-inline-block">
                                                    <div>Outcomes First</div>
                                                </a>
                                                <a href="/contextualads" class="section-footer_link w-inline-block">
                                                    <div>Contextual SearchSignals</div>
                                                </a>
                                                <a href="/deals-desk" class="section-footer_link w-inline-block">
                                                    <div>Deals Desk</div>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="section-footer_links-col">
                                            <div class="text-weight-bold">
                                                <div class="text-size-xxsmall">Legal &amp;Compliance</div>
                                            </div>
                                            <div class="spacer-xsmall"></div>
                                            <div class="section-footer_links">
                                                <a href="/legal/tos/" class="section-footer_link w-inline-block">
                                                    <div class="text-block-28">Terms of Service</div>
                                                </a>
                                                <a href="/legal/inventorypolicies/" class="section-footer_link w-inline-block">
                                                    <div>Inventory Policy</div>
                                                </a>
                                                <a href="/ad-quality-policy/" class="section-footer_link w-inline-block">
                                                    <div>Ad Quality Policy</div>
                                                </a>
                                                <a href="/privacy-policy/" class="section-footer_link w-inline-block">
                                        ...
                                        <div class="section-footer_links-col">
                                            <div class="text-weight-bold">
                                                <div class="text-size-xxsmall">Your Choices</div>
                                            </div>
                                            <div class="spacer-xsmall"></div>
                                            <div class="section-footer_links">
                                                <a href="/optout/" class="section-footer_link w-inline-block">
                                                    <div class="text-block-29">Opt Out</div>
                                                </a>
                                                <a href="/preferences/" class="section-footer_link w-inline-block">
                                                    <div>Preferences</div>
                                                </a>
                                                <a id="dnslink" href="#" class="section-footer_link dnslink-btn w-inline-block">
                                    ...
                                    <div class="section-footer_logo-strip">
                                        <div class="section-footer_logo-strip-item">
                                            <div class="w-embed">
                                                <img width="44" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/iab_logo_c.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="w-embed">
                                                <img width="44" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/iab_tech_lab_c.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="w-embed">
                                                <img width="101" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/daa_logo.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="w-embed">
                                                <img width="74.5" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/group-201321319195.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="w-embed">
                                                <img width="97" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/local_media_consortium_logo.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="code-embed-4 w-embed">
                                                <img src="https://s31073.pcdn.co/wf-assets/images/ana_logo_1.png" loading="lazy" width="64" sizes="64px" alt="" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                        <div class="section-footer_logo-strip-item">
                                            <div class="code-embed-5 w-embed">
                                                <img width="60" loading="lazy" alt="" src="https://s31073.pcdn.co/wf-assets/images/tag_logo.png" class="section-footer_logo-strip-item-image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="section-footer_bottom">
                                    <div class="max-width-small">
                                        <a href="/" aria-current="page" class="section-footer_logo w-inline-block w--current">
                                            <div class="section-footer_logo-embed w-embed">
                                    ...
                                    <div class="section-footer_spcial-links">
                                        <a href="https://www.instagram.com/medianetads/" target="_blank" class="section-footer_spcial-link w-inline-block">
                                            <div class="section-footer_spcial-link-icon w-embed">
                                        ...
                                        <a href="https://x.com/medianetads" target="_blank" class="section-footer_spcial-link w-inline-block">
                                            <div class="section-footer_spcial-link-icon w-embed">
                                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="https://www.linkedin.com/company/media.net" target="_blank" class="section-footer_spcial-link w-inline-block">
                                            <div class="section-footer_spcial-link-icon w-embed">
                                                <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div id="w-node-_11ec7a46-e983-cec4-fdca-5bd061a28eb4-86c2b393" class="button-block">
                                        <a data-w-id="d0ce4a2f-cc85-2b16-520b-0a7aed5e0153" href="/contact" class="button-primary inverse w-inline-block">
                                            <div class="button-primary-label inverse">
                                                <div>Contact Us</div>
                                            </div>
                                            <div class="button-primary-icon inverse">
                                            ...
                                            <div class="button-primary-fill inverse"></div>
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=66ed1f19164e8996fdcbd2db" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
        <script src="https://cdn.prod.website-files.com/66ed1f19164e8996fdcbd2db/js/webflow.20ddc37d.f0b0554a69f0898a.js" type="text/javascript"></script>
        <!-- Google Tag Manager (noscript) -->
        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TWLKW34" height="0" width="0" style="display:none;visibility:hidden"></iframe>
        </noscript>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                elVideosPlayOnce.forEach(video => {
                    ...
                    const videosObserver = new IntersectionObserver(videosObserverCB,{
                        threshold: videosObserverThreshold
                    });
                    ...
                    const playMarquee = () => {
                        ...
                        if (isHorizontal) {
                            ...
                            tween = gsap.fromTo(marquee.children, {
                                ...
                                y: isReverse ? 0 : distanceToTranslate,
                                duration,
                                ease: "none",
                                repeat: -1
                            });
        ...
        <script>
            ( () => {
                ...
                function checkDNS() {
                    ...
                    if (!('__cmp'in window) || typeof (__cmp) !== 'function') {
                        return
                    }
                    __cmp('getCMPData', true, function(x) {
                        ...
                        if ('regulationKey'in x && possibleKeys.indexOf(x.regulationKey) != -1) {
                            ccpaElem.style.display = 'inline-block';
                            /* show the link*/
                        } else {
                            ccpaElem.style.display = 'none';
                            /* don’t show the link*/
                        }
                    });
                }
        ...
        <!-- Disable Webflow's built-in smooth scroll, Add custom smooth scroll with offset. -->
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                // Select all links with href starting with '#' and filter
                const links = Array.from(document.querySelectorAll('a[href^="#"]')).filter(link => {
                    const href = link.getAttribute('href').trim();
                    return href.length > 1 && href[1] !== ' ';
                    // Ensure at least one non-space character after #
                }
                );
                ...
                function handleHashChange() {
                    if (window.location.hash) {
                        ...
                        if (targetId.trim()) {
                            // Ensure there's a non-space character
                            smoothScroll(targetId);
                        }
                    }
                }
